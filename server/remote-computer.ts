...
// inside the VM and WatcherBot Room never exposes another inbound port.
...
export const REMOTE_CUA_SESSION = "watcherbotroom";
export const REMOTE_CDP_HELPER = "/opt/ogb/watcherbotroom-cdp.mjs";
