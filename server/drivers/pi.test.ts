...
describe("buildMcpServers", () => {
  ...
  it("passes composio, agent, project, and phone integrations through as stdio servers", () => {
    const servers = buildMcpServers({
      ...
      integrations: {
        ...
        projectMcps: { studio: { command: "tsx", args: ["studio/mcp.ts"], env: {} } },
    ...
    expect(servers).toEqual({
      composio: { command: "node", args: ["c"], env: { A: "1" } },
      agents: { command: "node", args: ["a"], env: { B: "2" } },
      studio: { command: "tsx", args: ["studio/mcp.ts"], env: {} },
      phone: { command: "node", args: ["p"], env: {} },
    });
  });
