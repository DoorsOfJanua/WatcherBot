...
const CHROME_PROFILE = "$HOME/.watcherbotroom/chrome-profile";
...
const CHROME_PROFILE_SETUP = [
  ...
  "      exit 1",
  "    fi",
  '    mv "$browser_dir" "$browser_dir.pre-watcherbotroom-$(date +%s)-$$"',
  "  fi",
  ...
  if (msg.method === "initialize") {
    return send({
      ...
      result: {
        ...
        capabilities: { tools: {} },
        serverInfo: { name: "watcherbotroom-computer", version: "3" },
      },
    });
  }
