...
export const VPS_MANAGED_LABEL = "com.watcherbotroom.vps";
export const VPS_CONTAINER_LABEL = "com.watcherbotroom.container";
export const VPS_CONTAINER_PREFIX = "watcherbotroom-vps";
...
const SCREENSHOT_PATH = "/tmp/watcherbotroom-vps-preview.png";
  ...
  const operation = async () => {
    ...
    try {
      ...
      if (action === "provision") {
        ...
        // never docker-rm a container WatcherBot Room did not create, even one
