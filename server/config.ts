...
const appConfigSchema = z.object({
  ...
  /** Voice provider, ElevenLabs credential, and the selected voice id. xAI
   * voice uses the workspace xai.key credential rather than duplicating it. */
  tts: z
    .object({ provider: z.enum(["elevenlabs", "xai"]).optional(), key: optionalText, voice: optionalText })
    .optional(),
