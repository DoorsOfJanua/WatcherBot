...
Quit WatcherBot Room completely and launch it again. If the version did not change, install the latest release manually. Your conversations and settings live outside the application bundle and are not removed by replacing the app.
...
<Callout type="warn" title="Use official artifacts">
  Do not install update files forwarded through chat or uploaded to an unrelated repository. Use the WatcherBot Room releases repository and its checksums.
</Callout>
