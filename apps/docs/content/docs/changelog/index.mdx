---
title: Changelog
description: Highlights from recent WatcherBot Room desktop releases.
icon: Clock
---
...
<Callout type="info" title="Every release remains available">
  Browse checksums, installers, and older notes in the [WatcherBot Room releases repository](https://github.com/milind-soni/openmausbot-releases/releases).
</Callout>
