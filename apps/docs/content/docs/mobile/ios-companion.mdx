---
title: iOS companion
description: Pair an iPhone directly with the WatcherBot Room instance running on your computer.
icon: Smartphone
---
...
There is no hosted WatcherBot Room relay. Bonjour does not cross Tailscale, so remote connections use manual address entry.
