---
title: Self-hosting WatcherBot Room
description: Run the harness and desktop app on infrastructure you control.
icon: Server
---

WatcherBot Room is local-first by default: the harness listens on loopback, agent CLIs run on your machine, and application state lives under `~/.openmausbot`.

## Typical self-hosted setup

1. Run WatcherBot Room on your personal macOS, Windows, or Ubuntu computer.
...
Self-hosting WatcherBot Room does not self-host every optional provider:
