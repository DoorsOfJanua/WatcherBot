...
export function CompanionSection() {
  ...
  if (!bridge()) {
    return (
      <Card
        title="Companion"
        subtitle="The companion runs as its own process, which only the desktop app can start. Open The WatcherBot on this computer to turn it on."
      >
        <div />
      </Card>
    );
    ...
    <div className="flex flex-col gap-4">
      ...
      >
        ...
        {state.enabled && state.tailscale && !state.tailnetName && (
          <div className="mt-3 text-[13px] text-ink-secondary">
            ...
            The WatcherBot log for which paths were tried.
          </div>
        )}
      ...
      <Card
        ...
        subtitle={
          state.pairing
            ? pairingLink
              ? "Scan with your phone's Camera, then confirm in WatcherBot Mobile. You can also use the code manually."
              : "Open WatcherBot Mobile, choose this computer, and enter the code."
            : state.enabled
