...
export function CompanionSection({ profileEmail = "" }: { profileEmail?: string }) {
  ...
  if (!companionBridge()) {
    return (
      <Card
        title="Use WatcherBotRoom from your phone"
        subtitle="Open Settings in the WatcherBotRoom desktop app to set up a phone."
      />
    );
  }
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <Card
        title="Paired phones"
        subtitle={pairedCount ? "Manage the phones that can use this WatcherBotRoom." : "No phones are paired yet."}
      >
        {pairedCount > 0 && (
