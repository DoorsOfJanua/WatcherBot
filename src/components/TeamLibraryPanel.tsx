...
const COMMUNITY_TEAMS_REPOSITORY = "https://github.com/milind-soni/watcherbotroom-teams";
                ...
                <div>
                  ...
                  <div className="grid gap-5 md:grid-cols-2">
                    ...
                    >
                      ...
                      <span className="mt-1 text-[12.5px] text-ink-secondary">or drop a team .json here</span>
                    </button>
