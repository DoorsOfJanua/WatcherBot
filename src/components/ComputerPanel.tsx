...
export function ComputerPanel({
  ...
  const replaceVpsComputer = async () => {
    if (!window.confirm(`Replace ${bot.name}'s VPS computer with the version required by this WatcherBotRoom update? Files stored only inside the disposable container will be deleted.`)) return;
  ...
  const emptyState = {
    ...
    "vps-incompatible": "This VPS computer belongs to an earlier WatcherBotRoom version",
