...
2. Register the stable bundle ID `com.doorsofjanua.agentroom` used by `project.yml`.
3. Create the matching app in App Store Connect with the name **The WatcherBot**, primary category **Productivity**, and a unique SKU.
...
- Support URL: `https://github.com/DoorsOfJanua/WatcherBot/issues`
