...
extension WatcherState {
    ...
    static func normalize(_ value: String?) -> WatcherState? {
        guard let value, !value.isEmpty else { return nil }
        return WatcherState(rawValue: value) ?? legacy[value]
    }

    static func forBot(_ bot: Bot, last: Message?) -> WatcherState {
    ...
    static func forChat(_ chat: Chat, in state: CompanionState) -> WatcherState {
        switch chat {
